...
<Steps>
  ...
  <Step title="Wait for forecast generation">
    ...
    <Frame caption="Screenshot: The plan creation dialog with plan type, title, forecasting method dropdown, and date range picker">
      <img src="/images/platform/create-plan-dialog.png" alt="Plan creation dialog showing fields: Plan type (Tactical selected), Title text input, Forecasting method dropdown (e.g. LightGBM), Plan period date range selector, Description textarea, and Create button" />
    </Frame>
  </Step>
...
<Frame caption="Screenshot: The scenario three-dot menu showing 'Make Primary' option, and a scenario chip with the 'Primary' badge">
  <img src="/images/platform/make-primary-scenario.png" alt="Scenario Bar showing a scenario chip with three-dot menu expanded, highlighting the 'Make Primary' option. Another scenario chip displays the green 'Primary' badge" />
</Frame>
