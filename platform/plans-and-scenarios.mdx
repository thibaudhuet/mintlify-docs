...
<Steps>
  ...
  <Step title="Wait for forecast generation">
    ...
    <Frame caption="Screenshot: The plan creation dialog with plan type, title, forecasting method dropdown, and date range picker">
      ![Plan creation dialog showing fields: Plan type (Tactical selected), Title text input, Forecasting method dropdown (e.g. LightGBM), Plan period date range selector, Description textarea, and Create button](/images/platform/create-plan-dialog.png)
    </Frame>
...
<Frame caption="Screenshot: The scenario three-dot menu showing 'Make Primary' option, and a scenario chip with the 'Primary' badge">
  ![Scenario Bar showing a scenario chip with three-dot menu expanded, highlighting the 'Make Primary' option. Another scenario chip displays the green 'Primary' badge](/images/platform/make-primary-scenario.png)
</Frame>
