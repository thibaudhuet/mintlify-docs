...
<Frame caption="Screenshot: Plan Realization report with FY, YTD, YTG columns and color-coded variance">
  <img src="/images/tools/plan-realization-report.png" alt="Plan Realization report showing a dataset comparison table with FY, YTD, and YTG columns, monthly averages, and variance columns with green color coding for on-track values and red for at-risk values, with column rename and reorder controls visible" />
</Frame>
