...
| **Unconstrained Closing Stock (GSV)** | Lost | See [SIT Calculation Logic](/stock-in-trade/calculation-logic) |
| **Unconstrained Closing Stock (Volume)** | Lost | See [SIT Calculation Logic](/stock-in-trade/calculation-logic) |
| **Constrained Closing Stock (GSV)** | Lost | See [SIT Calculation Logic](/stock-in-trade/calculation-logic) |
| **Constrained Closing Stock (Volume)** | Lost | See [SIT Calculation Logic](/stock-in-trade/calculation-logic) |
