...
<Frame caption="Screenshot: Forecast strategy configuration showing recursive/non-recursive toggle and target transform option">
  <img src="/images/demand/forecast-strategy-config.png" alt="Forecast strategy configuration panel with a toggle switch between Recursive and Non-Recursive modes and a Target Transform checkbox or toggle beneath it." />
</Frame>
...
<Frame caption="Screenshot: The forecast settings dialog showing aggregation options for Product, Customer/Location, and Time dimensions">
  <img src="/images/demand/forecast-settings-dialog.png" alt="Forecast settings dialog with aggregation configuration sections for three dimensions: Product, Customer/Location, and Time. Each dimension has selectable granularity levels to control the detail of the generated forecast." />
</Frame>
...
<Frame caption="Screenshot: The explore products/customers panel showing product list with demand sparklines">
  <img src="/images/demand/explore-products-customers.png" alt="Panel within forecast settings listing products and/or customers. Each row displays the item name alongside a small sparkline chart showing its actual demand over the most recent year, helping identify items with low or no activity." />
</Frame>
